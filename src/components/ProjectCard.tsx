...
const ProjectCard: React.FC<ProjectCardProps> = ({
  ...
  return (
      <motion.div
          ...
          whileTap={{ scale: 0.98 }}
          className="group relative overflow-hidden rounded-xl p-1 transition-all duration-500 hover:shadow-xl flex-grow"
      >
        <div className="absolute inset-0 bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500 opacity-75 transition-all duration-500 group-hover:opacity-100 group-hover:blur-md" />
        <div className="relative h-full rounded-lg bg-white p-6 dark:bg-gray-800 transition-all duration-500 dark:bg-opacity-80 backdrop-blur-md flex flex-col shadow-lg">
          ...
          <div className="mt-auto space-y-4">
            ...
            <div className="flex justify-between">
              ...
              >
                <SiGithub className="mr-1" size={16} />
